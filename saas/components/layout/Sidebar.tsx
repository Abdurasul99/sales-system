...
const NAV_ITEMS: NavItem[] = [
  { label: "Аналитика", href: "/analytics", icon: BarChart3, roles: ["ADMIN", "SUPERADMIN"] },
  ...
  { label: "Валюта", href: "/currency", icon: DollarSign, roles: ["ADMIN"] },
...
export function Sidebar({ user }: SidebarProps) {
  ...
  const navItems = isSuperAdmin ? SUPERADMIN_ITEMS : NAV_ITEMS.filter(
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="border-t border-gray-100 p-3">
        {user.planName && !isSuperAdmin && !collapsed && (
